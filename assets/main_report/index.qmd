...
params:
  inputs: "_test_data/mycobacteroides/_no_group_defined__inputs"
execute:
  echo: false
...
```{r, results='asis', eval = length(alignments) <= 0}
cat('
Could not generate minimum spanning networks. This can happen when there are too few samples or too few SNPs.
')
```
