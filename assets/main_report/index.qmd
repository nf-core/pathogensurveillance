...
params:
  inputs: "/media/fosterz/external_primary/files/projects/work/current/pathogensurveillance/work/4f/b7f47de6034f16c175489b9a990526/xan_test_inputs"
execute:
  echo: false
---
...
```{r id_core_phylo, eval = length(core_phylo_paths) > 0, fig.height = 8}
core_plots <- lapply(core_phylo_paths, function(path) {
    psminer::make_phylogeny(path, sample_data, ref_data)
})
...
```{r, results='asis', eval = length(core_phylo_paths) > 0}
cat('
::: {.callout-tip collapse="true"}
## About this plot
