...
#NOTE-Will tidy up code once we finalize which tree program to use and input format. 
...
#To do-great a function to adjust SNP threshold to different numbers of SNPs and rerun this function for each value (5, 10, 25, 50)
