...
params:
  inputs: "_test_data/xanthomonas/xan_test_inputs"
execute:
  echo: false
---
...
```{r make MSN, eval = FALSE}
#TODO make parse snp align function
#TODO make tabs for MSN? Currently default is to color nodes by factors in color_by, but this could be a lot of MSNs
#TODO make interactive tree option
#TODO add error warning if fewer than 3 samples and don't make MSN?
#TODO add error if fewer than 3 samples because we cannot use cutoff_predictor function.
#To avoid erroring out, should need to discuss whether to just set very low snp threshold to 1?
#TODO add documentation
psminer::make_MSN(snp_align_paths, sample_data, snp_threshold=1, show_MLG_table=TRUE)
```
