...
params:
  inputs: "/media/fosterz/external_primary/files/projects/work/current/pathogensurveillance/work/00/81d71bfa71e6e627ba660ca907b4ed/all_inputs"
execute:
  echo: false
---
...
for (color_by in color_factors) {
    ...
    for (reference in names(snp_alignments)) {
        if (!is.null(snp_alignments[[reference]]) && nrow(snp_alignments[[reference]]) > 4) {
            ...
            cat('There is no MSN to draw. See staus messages at the start of the report for details.\n\n')
        }
    }
}
