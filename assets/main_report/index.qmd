...
params:
    inputs: "/home/fosterz/projects/pathogensurveillance/work/2c/2b1d1b5bb4b18ef2dfcdab93975b61/all_inputs"
execute:
    echo: false
...
```{r plot_multigene_tree, results='asis', eval =has_multigene_tree}
plot_one <- function(x) {
    print(core_plots[[x]])
}
