...
n_core_genes <- if (has_multigene_tree) sum(multigene_tree_paths$method == 'core') else 0L
```
...
This is a multigene phylogeny of samples with reference genomes for context, inferred from ", n_core_genes, " core genes.
