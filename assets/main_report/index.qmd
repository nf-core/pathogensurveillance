...
```{r}
psminer::print_best_match_table(ani_matrix * 100, sample_data, ref_data, metric_name = 'ANI (%)')
```
...
```{r}
# psminer::print_best_match_table(pocp_matrix  * 100, sample_data, ref_data, metric_name = 'POCP (%)')
```
...
POCP is used to measure how the proportion of proteins shared between two genomes. 
...
:::
