...
print_figures_with_selector(plot_one, selector = names(core_plots), label = 'Color', img_class = 'core-gene-phylo', width = 1500 + max_label_size * 30, height = 300 + tip_count * 60, res = 250)
```
