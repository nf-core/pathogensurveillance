...
if (!require(phylocanvas)) install.packages('poppr', repos='http://cran.us.r-project.org')
if (!require(phylocanvas)) install.packages('metacoder', repos='http://cran.us.r-project.org')
