...
#nj_tree <- root(nj_tree, names(which.min(colMeans(group_ani[sample_ids, ]))))
...
#TO discuss-ran into instances where negative branches were output. One idea is to set these negative branches to very small positive values. Tree is simply a means to visualize ANI data before core gene phylogeny is produced. 
