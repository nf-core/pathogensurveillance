...
print_figures_with_selector(plot_one, selector = names(core_plots), label = 'Color', img_class = 'core-gene-phylo', width = 1700 + max_label_size * 30, height = 500 + tip_count * 60, res = 300)
```
...
print_figures_with_selector(plot_one, selector = names(snp_plots), label = 'Color', img_class = 'snp-gene-phylo', width = 1700 + max_label_size * 30, height = 500 + tip_count * 60, res = 300)
```
