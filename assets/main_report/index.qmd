...
params:
    inputs: "/home/fosterz/projects/pathogensurveillance/tests/output/small_genome/prepare_report_input/all_inputs"
execute:
    echo: false
...
```{r ani_heatmap}
estimated_ani_heatmap(params$inputs, interactive = TRUE, height = 1000, width = 1000)[[1]]
```
