...
The pipeline accepts the paths to raw Illumina, Pacbio, or Nanopore reads for one or more organisms and creates reports in the form of interactive HTML reports or PDF documents.
